...
set_property PACKAGE_PIN M21 [get_ports FPGA_GENLED]
...
set_property PACKAGE_PIN Y28 [get_ports {pxiTrigBus[7]}]
...
set_property PACKAGE_PIN P30 [get_ports sys_clk_n]
...
#set_property PACKAGE_PIN AL29 [get_ports {bck_H[0]}]
##bck_H[0]
#set_property IOSTANDARD LVCMOS33 [get_ports {bck_H[0]}]
#set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets {bck_H_IBUF[0]}]

#set_property PACKAGE_PIN AJ29 [get_ports {bck_H[1]}]
##bck_H[1]
#set_property IOSTANDARD LVCMOS33 [get_ports {bck_H[1]}]
#set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets {bck_H_IBUF[1]}]

#set_property PACKAGE_PIN AL27 [get_ports {bck_H[2]}]
##bck_H[2]
#set_property IOSTANDARD LVCMOS33 [get_ports {bck_H[2]}]
#set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets {bck_H_IBUF[2]}]

#set_property PACKAGE_PIN AP29 [get_ports {bck_H[3]}]
##bck_H[3]
#set_property IOSTANDARD LVCMOS33 [get_ports {bck_H[3]}]
#set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets {bck_H_IBUF[3]}]

#set_property PACKAGE_PIN AN32 [get_ports {bck_H[4]}]
##bck_H[4]
#set_property IOSTANDARD LVCMOS33 [get_ports {bck_H[4]}]
#set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets {bck_H_IBUF[4]}]

#set_property PACKAGE_PIN AJ31 [get_ports {bck_H[5]}]
##bck_H[5]
#set_property IOSTANDARD LVCMOS33 [get_ports {bck_H[5]}]
#set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets {bck_H_IBUF[5]}]

#set_property PACKAGE_PIN AN27 [get_ports {bck_H[6]}]
##bck_H[6]
#set_property IOSTANDARD LVCMOS33 [get_ports {bck_H[6]}]
#set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets {bck_H_IBUF[6]}]

#set_property PACKAGE_PIN AP25 [get_ports {bck_H[7]}]
##bck_H[7]
#set_property IOSTANDARD LVCMOS33 [get_ports {bck_H[7]}]
#set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets {bck_H_IBUF[7]}]

#set_property PACKAGE_PIN AN26 [get_ports {bck_H[8]}]
##bck_H[8]
#set_property IOSTANDARD LVCMOS33 [get_ports {bck_H[8]}]
#set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets {bck_H_IBUF[8]}]

#set_property PACKAGE_PIN AM29 [get_ports {bck_H[9]}]
##bck_H[9]
#set_property IOSTANDARD LVCMOS33 [get_ports {bck_H[9]}]
#set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets {bck_H_IBUF[9]}]

#set_property PACKAGE_PIN AP28 [get_ports {bck_H[10]}]
##bck_H[10]
#set_property IOSTANDARD LVCMOS33 [get_ports {bck_H[10]}]
#set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets {bck_H_IBUF[10]}]

#set_property PACKAGE_PIN AJ25 [get_ports {bck_H[11]}]
##bck_H[11]
#set_property IOSTANDARD LVCMOS33 [get_ports {bck_H[11]}]
#set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets {bck_H_IBUF[11]}]

#set_property PACKAGE_PIN AL28 [get_ports {lrck[0]}]
##lrck[0]
#set_property IOSTANDARD LVCMOS33 [get_ports {lrck[0]}]

#set_property PACKAGE_PIN AM30 [get_ports {lrck[1]}]
##lrck[1]
#set_property IOSTANDARD LVCMOS33 [get_ports {lrck[1]}]

#set_property PACKAGE_PIN AK27 [get_ports {lrck[2]}]
##lrck[2]
#set_property IOSTANDARD LVCMOS33 [get_ports {lrck[2]}]

#set_property PACKAGE_PIN AP31 [get_ports {lrck[3]}]
##v[3]
#set_property IOSTANDARD LVCMOS33 [get_ports {lrck[3]}]

#set_property PACKAGE_PIN AM31 [get_ports {lrck[4]}]
##lrck[4]
#set_property IOSTANDARD LVCMOS33 [get_ports {lrck[4]}]

#set_property PACKAGE_PIN AK31 [get_ports {lrck[5]}]
##lrck[5]
#set_property IOSTANDARD LVCMOS33 [get_ports {lrck[5]}]

#set_property PACKAGE_PIN AM27 [get_ports {lrck[6]}]
##lrck[6]
#set_property IOSTANDARD LVCMOS33 [get_ports {lrck[6]}]

#set_property PACKAGE_PIN AP33 [get_ports {lrck[7]}]
##lrck[7]
#set_property IOSTANDARD LVCMOS33 [get_ports {lrck[7]}]

#set_property PACKAGE_PIN AM26 [get_ports {lrck[8]}]
##lrck[8]
#set_property IOSTANDARD LVCMOS33 [get_ports {lrck[8]}]

#set_property PACKAGE_PIN AK11 [get_ports {lrck[9]}]
##lrck[9]
#set_property IOSTANDARD LVCMOS33 [get_ports {lrck[9]}]

#set_property PACKAGE_PIN AN28 [get_ports {lrck[10]}]
##lrck[10]
#set_property IOSTANDARD LVCMOS33 [get_ports {lrck[10]}]

#set_property PACKAGE_PIN AK26 [get_ports {lrck[11]}]
##lrck[11]
#set_property IOSTANDARD LVCMOS33 [get_ports {lrck[11]}]

#set_property PACKAGE_PIN AL30 [get_ports {serialDataIn[0]}]
##serialDataIn[0]
#set_property IOSTANDARD LVCMOS33 [get_ports {serialDataIn[0]}]

#set_property PACKAGE_PIN AK30 [get_ports {serialDataIn[1]}]
##serialDataIn[1]
#set_property IOSTANDARD LVCMOS33 [get_ports {serialDataIn[1]}]

#set_property PACKAGE_PIN AN31 [get_ports {serialDataIn[2]}]
##serialDataIn[2]
#set_property IOSTANDARD LVCMOS33 [get_ports {serialDataIn[2]}]

#set_property PACKAGE_PIN AP30 [get_ports {serialDataIn[3]}]
##serialDataIn[3]
#set_property IOSTANDARD LVCMOS33 [get_ports {serialDataIn[3]}]

#set_property PACKAGE_PIN AJ30 [get_ports {serialDataIn[4]}]
##serialDataIn[4]
#set_property IOSTANDARD LVCMOS33 [get_ports {serialDataIn[4]}]

#set_property PACKAGE_PIN AK32 [get_ports {serialDataIn[5]}]
##serialDataIn[5]
#set_property IOSTANDARD LVCMOS33 [get_ports {serialDataIn[5]}]

#set_property PACKAGE_PIN AN33 [get_ports {serialDataIn[6]}]
##serialDataIn[6]
#set_property IOSTANDARD LVCMOS33 [get_ports {serialDataIn[6]}]

#set_property PACKAGE_PIN AP26 [get_ports {serialDataIn[7]}]
##serialDataIn[7]
#set_property IOSTANDARD LVCMOS33 [get_ports {serialDataIn[7]}]

#set_property PACKAGE_PIN AJ11 [get_ports {serialDataIn[8]}]
##serialDataIn[8]
#set_property IOSTANDARD LVCMOS33 [get_ports {serialDataIn[8]}]

#set_property PACKAGE_PIN AN29 [get_ports {serialDataIn[9]}]
##serialDataIn[9]
#set_property IOSTANDARD LVCMOS33 [get_ports {serialDataIn[9]}]

#set_property PACKAGE_PIN AJ26 [get_ports {serialDataIn[10]}]
##serialDataIn[10]
#set_property IOSTANDARD LVCMOS33 [get_ports {serialDataIn[10]}]

#set_property PACKAGE_PIN AJ10 [get_ports {serialDataIn[11]}]
##serialDataIn[11]
#set_property IOSTANDARD LVCMOS33 [get_ports {serialDataIn[11]}]
...
set_property PACKAGE_PIN AB20 [get_ports {adc_spi_miso[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {adc_spi_miso[0]}]
set_property PACKAGE_PIN G2 [get_ports {adc_spi_miso[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {adc_spi_miso[1]}]
set_property PACKAGE_PIN E3 [get_ports {adc_spi_miso[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {adc_spi_miso[2]}]
set_property PACKAGE_PIN L15 [get_ports {adc_spi_miso[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {adc_spi_miso[3]}]
set_property PACKAGE_PIN Y16 [get_ports {adc_spi_miso[4]}]
set_property IOSTANDARD LVCMOS33 [get_ports {adc_spi_miso[4]}]
set_property PACKAGE_PIN AB15 [get_ports {adc_spi_miso[5]}]
set_property IOSTANDARD LVCMOS33 [get_ports {adc_spi_miso[5]}]
set_property PACKAGE_PIN M2 [get_ports {adc_spi_miso[6]}]
set_property IOSTANDARD LVCMOS33 [get_ports {adc_spi_miso[6]}]
set_property PACKAGE_PIN V17 [get_ports {adc_spi_miso[7]}]
set_property IOSTANDARD LVCMOS33 [get_ports {adc_spi_miso[7]}]

set_property PACKAGE_PIN AA20 [get_ports {adc_spi_mosi[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {adc_spi_mosi[0]}]
set_property PACKAGE_PIN L5 [get_ports {adc_spi_mosi[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {adc_spi_mosi[1]}]
set_property PACKAGE_PIN M17 [get_ports {adc_spi_mosi[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {adc_spi_mosi[2]}]
set_property PACKAGE_PIN N15 [get_ports {adc_spi_mosi[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {adc_spi_mosi[3]}]
set_property PACKAGE_PIN AA15 [get_ports {adc_spi_mosi[4]}]
set_property IOSTANDARD LVCMOS33 [get_ports {adc_spi_mosi[4]}]
set_property PACKAGE_PIN R18 [get_ports {adc_spi_mosi[5]}]
set_property IOSTANDARD LVCMOS33 [get_ports {adc_spi_mosi[5]}]
set_property PACKAGE_PIN R14 [get_ports {adc_spi_mosi[6]}]
set_property IOSTANDARD LVCMOS33 [get_ports {adc_spi_mosi[6]}]
set_property PACKAGE_PIN AA11 [get_ports {adc_spi_mosi[7]}]
set_property IOSTANDARD LVCMOS33 [get_ports {adc_spi_mosi[7]}]

set_property PACKAGE_PIN AB18 [get_ports {adc_spi_clk[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {adc_spi_clk[0]}]
set_property PACKAGE_PIN H2 [get_ports {adc_spi_clk[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {adc_spi_clk[1]}]
set_property PACKAGE_PIN M15 [get_ports {adc_spi_clk[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {adc_spi_clk[2]}]
set_property PACKAGE_PIN L16 [get_ports {adc_spi_clk[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {adc_spi_clk[3]}]
set_property PACKAGE_PIN U16 [get_ports {adc_spi_clk[4]}]
set_property IOSTANDARD LVCMOS33 [get_ports {adc_spi_clk[4]}]
set_property PACKAGE_PIN U18 [get_ports {adc_spi_clk[5]}]
set_property IOSTANDARD LVCMOS33 [get_ports {adc_spi_clk[5]}]
set_property PACKAGE_PIN AB12 [get_ports {adc_spi_clk[6]}]
set_property IOSTANDARD LVCMOS33 [get_ports {adc_spi_clk[6]}]
set_property PACKAGE_PIN W15 [get_ports {adc_spi_clk[7]}]
set_property IOSTANDARD LVCMOS33 [get_ports {adc_spi_clk[7]}]

set_property PACKAGE_PIN AA21 [get_ports {adc_rdl[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {adc_rdl[0]}]
set_property PACKAGE_PIN J6 [get_ports {adc_rdl[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {adc_rdl[1]}]
set_property PACKAGE_PIN P17 [get_ports {adc_rdl[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {adc_rdl[2]}]
set_property PACKAGE_PIN G17 [get_ports {adc_rdl[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {adc_rdl[3]}]
set_property PACKAGE_PIN AA16 [get_ports {adc_rdl[4]}]
set_property IOSTANDARD LVCMOS33 [get_ports {adc_rdl[4]}]
set_property PACKAGE_PIN U17 [get_ports {adc_rdl[5]}]
set_property IOSTANDARD LVCMOS33 [get_ports {adc_rdl[5]}]
set_property PACKAGE_PIN N4 [get_ports {adc_rdl[6]}]
set_property IOSTANDARD LVCMOS33 [get_ports {adc_rdl[6]}]
set_property PACKAGE_PIN Y14 [get_ports {adc_rdl[7]}]
set_property IOSTANDARD LVCMOS33 [get_ports {adc_rdl[7]}]

set_property PACKAGE_PIN AB22 [get_ports {adc_cnv[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {adc_cnv[0]}]
set_property PACKAGE_PIN G4 [get_ports {adc_cnv[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {adc_cnv[1]}]
set_property PACKAGE_PIN M16 [get_ports {adc_cnv[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {adc_cnv[2]}]
set_property PACKAGE_PIN L18 [get_ports {adc_cnv[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {adc_cnv[3]}]
set_property PACKAGE_PIN W17 [get_ports {adc_cnv[4]}]
set_property IOSTANDARD LVCMOS33 [get_ports {adc_cnv[4]}]
set_property PACKAGE_PIN V18 [get_ports {adc_cnv[5]}]
set_property IOSTANDARD LVCMOS33 [get_ports {adc_cnv[5]}]
set_property PACKAGE_PIN T14 [get_ports {adc_cnv[6]}]
set_property IOSTANDARD LVCMOS33 [get_ports {adc_cnv[6]}]
set_property PACKAGE_PIN AB13 [get_ports {adc_cnv[7]}]
set_property IOSTANDARD LVCMOS33 [get_ports {adc_cnv[7]}]

set_property PACKAGE_PIN AB21 [get_ports {adc_busy[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {adc_busy[0]}]
set_property PACKAGE_PIN H5 [get_ports {adc_busy[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {adc_busy[1]}]
set_property PACKAGE_PIN M16 [get_ports {adc_busy[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {adc_busy[2]}]
set_property PACKAGE_PIN N17 [get_ports {adc_busy[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {adc_busy[3]}]
set_property PACKAGE_PIN H18 [get_ports {adc_busy[4]}]
set_property IOSTANDARD LVCMOS33 [get_ports {adc_busy[4]}]
set_property PACKAGE_PIN P20 [get_ports {adc_busy[5]}]
set_property IOSTANDARD LVCMOS33 [get_ports {adc_busy[5]}]
set_property PACKAGE_PIN M3 [get_ports {adc_busy[6]}]
set_property IOSTANDARD LVCMOS33 [get_ports {adc_busy[6]}]
set_property PACKAGE_PIN AA14 [get_ports {adc_busy[7]}]
set_property IOSTANDARD LVCMOS33 [get_ports {adc_busy[7]}]

set_property PACKAGE_PIN AA19 [get_ports {adc_rst[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {adc_rst[0]}]
set_property PACKAGE_PIN Y22 [get_ports {adc_rst[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {adc_rst[1]}]
set_property PACKAGE_PIN D2 [get_ports {adc_rst[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {adc_rst[2]}]
set_property PACKAGE_PIN J17 [get_ports {adc_rst[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {adc_rst[3]}]
set_property PACKAGE_PIN AB17 [get_ports {adc_rst[4]}]
set_property IOSTANDARD LVCMOS33 [get_ports {adc_rst[4]}]
set_property PACKAGE_PIN AA13 [get_ports {adc_rst[5]}]
set_property IOSTANDARD LVCMOS33 [get_ports {adc_rst[5]}]
set_property PACKAGE_PIN V14 [get_ports {adc_rst[6]}]
set_property IOSTANDARD LVCMOS33 [get_ports {adc_rst[6]}]
set_property PACKAGE_PIN V15 [get_ports {adc_rst[7]}]
set_property IOSTANDARD LVCMOS33 [get_ports {adc_rst[7]}]

#### AFE #####

set_property PACKAGE_PIN U15 [get_ports {afe_spi_miso[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {afe_spi_miso[0]}]
set_property PACKAGE_PIN N2 [get_ports {afe_spi_miso[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {afe_spi_miso[1]}]

set_property PACKAGE_PIN T16 [get_ports {afe_spi_mosi[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {afe_spi_mosi[0]}]
set_property PACKAGE_PIN U1 [get_ports {afe_spi_mosi[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {afe_spi_mosi[1]}]

set_property PACKAGE_PIN F4 [get_ports {afe_spi_clk[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {afe_spi_clk[0]}]
set_property PACKAGE_PIN N3 [get_ports {afe_spi_clk[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {afe_spi_clk[1]}]

set_property PACKAGE_PIN K14 [get_ports {afe_spi_cs[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {afe_spi_cs[0]}]
set_property PACKAGE_PIN E2 [get_ports {afe_spi_cs[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {afe_spi_cs[1]}]
set_property PACKAGE_PIN K16 [get_ports {afe_spi_cs[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {afe_spi_cs[2]}]
set_property PACKAGE_PIN K21 [get_ports {afe_spi_cs[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {afe_spi_cs[3]}]
set_property PACKAGE_PIN T3 [get_ports {afe_spi_cs[4]}]
set_property IOSTANDARD LVCMOS33 [get_ports {afe_spi_cs[4]}]
set_property PACKAGE_PIN AA10 [get_ports {afe_spi_cs[5]}]
set_property IOSTANDARD LVCMOS33 [get_ports {afe_spi_cs[5]}]
set_property PACKAGE_PIN AB10 [get_ports {afe_spi_cs[6]}]
set_property IOSTANDARD LVCMOS33 [get_ports {afe_spi_cs[6]}]
set_property PACKAGE_PIN N14 [get_ports {afe_spi_cs[7]}]
set_property IOSTANDARD LVCMOS33 [get_ports {afe_spi_cs[7]}]